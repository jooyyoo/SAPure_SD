		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAPure",
									"targetURL": "#zc503sdgw0001sapuresdfertview-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc503sdgw0001sapuresdfertview-display": {
								"semanticObject": "zc503sdgw0001sapuresdfertview",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc503sd.gw0001.sapuresdfertview",
									"url": sap.ui.require.toUrl("zc503sd/gw0001/sapuresdfertview")
								}
							}
						}
					}
