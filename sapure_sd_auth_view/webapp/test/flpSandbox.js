		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAPure",
									"targetURL": "#zc503sdgw0004sapuresdauthview-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc503sdgw0004sapuresdauthview-display": {
								"semanticObject": "zc503sdgw0004sapuresdauthview",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc503sd.gw0004.sapuresdauthview",
									"url": sap.ui.require.toUrl("zc503sd/gw0004/sapuresdauthview")
								}
							}
						}
					}
