		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAPure",
									"targetURL": "#zc503sdgw0011sapuresdcartview-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc503sdgw0011sapuresdcartview-display": {
								"semanticObject": "zc503sdgw0011sapuresdcartview",
								"action": "display",
								"description": "[SD] 장바구니",
								"title": "SAPure",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc503sd.gw0011.sapuresdcartview",
									"url": sap.ui.require.toUrl("zc503sd/gw0011/sapuresdcartview")
								}
							}
						}
					}
